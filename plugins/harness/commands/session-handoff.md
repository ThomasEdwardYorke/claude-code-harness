...
| S-13 | `backlog.md` が肥大化 — 150 行超で WARN / 200 行超で FAIL (**再肥大化 guard**、monolithic session-prompt 再発防止、Gate 1 Structural 由来) | Gate 2 の Context loaded 行数 (`Read` 結果) を流用 — 追加 `Bash: wc -l` は不要 | WARN (150+) / FAIL (200+) |
