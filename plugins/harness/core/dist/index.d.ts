...
type HookType = "pre-tool" | "post-tool" | "permission" | "session-start" | "session-end" | "pre-compact" | "subagent-stop" | "task-created" | "task-completed" | "stop" | "worktree-remove" | "worktree-create" | "user-prompt-submit" | "post-tool-use-failure";
